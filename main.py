...
class UkrOSWelcome(QWidget):
    def __init__(self):
        ...
        self.next_button_fifth = QPushButton("Next", self)
        self.next_button_fifth.clicked.connect(self.next_sixth)
        self.next_button_fifth.setGeometry(535, 360, 60, 35)
        self.next_button_fifth.hide()
    ...
    def next_third(self):
        ...
        self.label_first.setText("What programs do you want to install?")
